...
docker pull andrewrothstein/docker-ansible:ubuntu_vivid
docker pull andrewrothstein/docker-ansible:ubuntu_wily
...
docker build -t andrewrothstein/docker-julia:ubuntu_vivid ubuntu_vivid
docker build -t andrewrothstein/docker-julia:ubuntu_wily ubuntu_wily
